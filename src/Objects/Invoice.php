...
class Invoice
{
    ...
    private $module_source = null;
    private $pos_source = null;
    ...
    public function toArray(): array
    {
        ...
        // Convertir chaque ligne en tableau si c'est un objet OrderLine
        if (!empty($this->lines)) {
        ...
        foreach ($data as $key => $value) {
            if (property_exists($invoice, $key)) {
                if ($key === 'lines' && (is_array($value)|| is_object($value))) {
                    // Ici on pourrait utiliser OrderLine si les lignes sont de type OrderLine
                    $invoice->lines = array_map(fn($lineData) => Line::fromApiResponse($lineData), $value);
                } else {
                    $invoice->$key = $value;
                }
            }
    ...
    public function setTotalTTC(?float $total_ttc): self { $this->total_ttc = $total_ttc; return $this; }
     ...
     */
    public function setAvailabilityId($availability_id): self
    {
    ...
    /**
     * Get the value of retained_warranty_date_limit
     */
    public function getRetainedWarrantyDateLimit()
    {
        return $this->retained_warranty_date_limit;
    }

    /**
     * Set the value of retained_warranty_date_limit
     */
    public function setRetainedWarrantyDateLimit($retained_warranty_date_limit): self
    {
        $this->retained_warranty_date_limit = $retained_warranty_date_limit;
    ...
    /**
     * Get the value of retained_warranty
     */
    public function getRetainedWarranty()
    {
        return $this->retained_warranty;
    }

    /**
     * Set the value of retained_warranty
     */
    public function setRetainedWarranty($retained_warranty): self
    {
        $this->retained_warranty = $retained_warranty;

        return $this;
    }

    /**
     * Get the value of tab_previous_situation_invoice
     */
    public function getTabPreviousSituationInvoice(): array
    {
        return $this->tab_previous_situation_invoice;
    }

    /**
     * Set the value of tab_previous_situation_invoice
     */
    public function setTabPreviousSituationInvoice(array $tab_previous_situation_invoice): self
    {
        $this->tab_previous_situation_invoice = $tab_previous_situation_invoice;
    ...
    /**
     * Get the value of tab_next_situation_invoice
     */
    public function getTabNextSituationInvoice(): array
    {
        return $this->tab_next_situation_invoice;
    }

    /**
     * Set the value of tab_next_situation_invoice
     */
    public function setTabNextSituationInvoice(array $tab_next_situation_invoice): self
    {
        $this->tab_next_situation_invoice = $tab_next_situation_invoice;
    ...
    /**
     * Get the value of situation_final
     */
    public function getSituationFinal()
    {
        return $this->situation_final;
    }

    /**
     * Set the value of situation_final
     */
    public function setSituationFinal($situation_final): self
    {
        $this->situation_final = $situation_final;

        return $this;
    }

    /**
     * Get the value of situation_counter
     */
    public function getSituationCounter()
    {
        return $this->situation_counter;
    }

    /**
     * Set the value of situation_counter
     */
    public function setSituationCounter($situation_counter): self
    {
        $this->situation_counter = $situation_counter;

        return $this;
    }

    /**
     * Get the value of date_pointoftax
     */
    public function getDatePointoftax()
    {
        return $this->date_pointoftax;
    }
    ...
    /**
     * Get the value of pos_source
     */
    public function getPosSource()
    {
        return $this->pos_source;
    }

    /**
     * Set the value of pos_source
     */
    public function setPosSource($pos_source): self
    {
    ...
    /**
     * Get the value of module_source
     */
    ...
    /**
     * Set the value of module_source
     */
    public function setModuleSource($module_source): self
    {
